          ...
          <div className="w-full max-w-md">
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-5">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-2.5 px-4 bg-blue-500 text-white rounded-lg text-sm font-semibold shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors disabled:opacity-50"
              >
            ...
            <div className="flex justify-center pt-15">
              <Link
                to="/login"
                className="inline-flex items-center gap-2 text-sm font-semibold text-slate-600  hover:text-blue-400 transition-colors group"
              >
