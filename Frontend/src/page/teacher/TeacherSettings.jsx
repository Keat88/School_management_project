...
import { LuUser, LuLock, LuBell, LuSave, LuShield, LuMail, LuPhone, LuMapPin } from "react-icons/lu";
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 p-6 font-sans text-slate-800 dark:text-slate-100">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          {/* Main Content Area */}
          <div className="flex-1 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-6 shadow-xs">
            <form onSubmit={handleSubmit}>
              ...
              {activeTab === "profile" && (
                <div className="space-y-5">
                  <div className="border-b border-slate-100 dark:border-slate-800 pb-4">
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">Update your identity and contact details.</p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-10 pr-4 py-2 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-xs text-slate-800 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600"
                        />
                      </div>
                    </div>
                    ...
                    <div>
                      <label className="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1.5">Location / Address</label>
                      <div className="relative">
              ...
              {activeTab === "security" && (
                <div className="space-y-5">
                  <div className="border-b border-slate-100 dark:border-slate-800 pb-4">
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">Ensure your account is using a secure password.</p>
                  </div>
                  ...
                  <div className="space-y-4 max-w-md">
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        placeholder="••••••••"
                        className="w-full px-4 py-2 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-xs text-slate-800 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600"
                      />
                    </div>
              ...
              {activeTab === "notifications" && (
                <div className="space-y-5">
                  <div className="border-b border-slate-100 dark:border-slate-800 pb-4">
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">Choose how you want to receive alerts and updates.</p>
                  </div>
                  ...
                  <div className="space-y-4">
                    <label className="flex items-center justify-between p-3.5 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 cursor-pointer">
                      <div>
                        ...
                        <span className="text-[11px] text-slate-500 dark:text-slate-400">Receive daily summary of attendance and system announcements.</span>
                      </div>
                      <input
                        type="checkbox"
                    ...
                    <label className="flex items-center justify-between p-3.5 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 cursor-pointer">
                      <div>
                        ...
                        <span className="text-[11px] text-slate-500 dark:text-slate-400">Receive instant alerts on your browser when class schedules change.</span>
                      </div>
                      <input
                        type="checkbox"
              ...
              <div className="mt-6 pt-4 border-t border-slate-100 dark:border-slate-800 flex justify-end">
                <button
                  type="submit"
                  className="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-xl text-xs font-semibold shadow-sm transition-all flex items-center gap-2 cursor-pointer"
                >
                  <LuSave size={16} />
