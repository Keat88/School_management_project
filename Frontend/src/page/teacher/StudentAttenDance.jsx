                  ...
                  <td className="py-4 px-4 sm:px-6">
                    {student.locked ? (
                      ...
                      <input
                        ...
                        placeholder="Reason..."
                        className="w-full rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-800 px-3.5 py-2 text-xs text-slate-800 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20  dark:focus:bg-slate-800 transition-all"
                      />
                    )}
                  </td>
                </tr>
