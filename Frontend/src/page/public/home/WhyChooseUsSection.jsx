...
export default function WhyChooseUsSection() {
  ...
  return (
    <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto bg-gray-50/50 dark:bg-slate-950 transition-colors duration-300">
      {/* Section Header */}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {features.map((feature, index) => (
          <div 
            key={index} 
            className="bg-white dark:bg-slate-900 rounded-3xl p-6 sm:p-8 shadow-sm border border-gray-100 dark:border-slate-800 flex flex-col justify-between duration-200 transition-transform hover:-translate-y-0.5 hover:shadow-md transition-colors"
          >
            <div>
              {/* Icon */}
