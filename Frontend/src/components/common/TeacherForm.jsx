...
export default function StudentForm({
  ...
  // Enhanced Image Handler with Validation
        ...
        >
              ...
              {isEdit && currentStudent?.roll_number && (
                <div>
                  ...
                  <input
                    ...
                    disabled
                    className="w-full px-3.5 py-2.5 border rounded-xl text-sm cursor-not-allowed bg-gray-100 border-gray-200 text-gray-500 dark:bg-slate-800/40 dark:border-slate-800 dark:text-slate-500"
                  />
                </div>
              )}
              ...
              <div className="md:col-span-2">
                ...
                <div className="flex items-center gap-4 mt-2">
                  ...
                  <input
                    ...
                    className="w-full text-sm cursor-pointer file:mr-4 file:py-2.5 file:px-4 file:rounded-xl file:border-0 file:text-xs file:font-semibold file:uppercase file:tracking-wider text-gray-600 file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100 dark:text-slate-400 dark:file:bg-indigo-500/20 dark:file:text-indigo-300 dark:hover:file:bg-indigo-500/30"
                  />
                </div>
              </div>
            </div>
          ...
          <div className="flex items-center justify-end space-x-3 pt-6 border-t border-gray-100 dark:border-slate-800">
            <button
              type="button"
              onClick={() => navigate(-1)}
              className="px-5 py-2.5 rounded-xl text-sm font-semibold transition-all cursor-pointer bg-gray-100 text-gray-700 hover:bg-gray-200 dark:bg-slate-800 dark:text-slate-300 dark:hover:bg-slate-700 dark:border dark:border-slate-700"
            >
              Cancel
            </button>
            <button
